...
export function GlassPanel({
  ...
  return (
    <div
      className={cn(
        "relative overflow-hidden rounded-3xl border border-white/[0.14] bg-[rgba(18,18,22,0.5)] shadow-[0_24px_80px_rgba(0,0,0,0.62),0_0_0_1px_rgba(255,255,255,0.04)_inset,inset_0_1px_0_rgba(255,255,255,0.1)] backdrop-blur-[32px] backdrop-saturate-150",
